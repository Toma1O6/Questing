...
public class ScrollableWidgetList<T, W extends Widget> extends ContainerWidget {
    ...
    public ScrollableWidgetList(int x, int y, int width, int height, List<T> data, WidgetFactory<T, W> factory) {
