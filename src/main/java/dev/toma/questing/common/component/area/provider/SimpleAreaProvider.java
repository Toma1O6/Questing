...
public abstract class SimpleAreaProvider<A extends SimpleArea<?>> implements AreaProvider<A> {
    ...
    public abstract A createAreaInstance(BlockPos areaCenter, List<Spawner> spawners);

    @Override
    public A generateArea(World world, Quest quest, Vector3d sourcePosition) {
        ...
        return this.createAreaInstance(areaCenter, spawners);
    }
